...
function mostrarConfirmacion() {
  ...
  // Enviar a Google Sheets
  fetch('https://script.google.com/macros/s/AKfycbyrw0Q8WWusdV2skoyM15OdYUWbO_e-S1PmGZUK72gFkBhhNmEsZ1hfu0BG0_N0rK1pOw/exec', {
    method: 'POST',
...
function confirmarWhatsapp(destino) {
  ...
  const mensajeSi = "Gracias por la invitación! Nos vemos en la celebración!";
  ...
  const numero = destino === 'claudia' ? '5216463077208' : '5216463077208';
